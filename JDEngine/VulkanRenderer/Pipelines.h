...
namespace JD {
	...
	void createLaplacePipelinefunc(vk::Pipeline& pipeline, vk::PipelineLayout& pipelineLayout, vk::Device device, vk::DescriptorSetLayout& descriptorSetLayout, float width, float height, vk::Format swapChainFormat) {
